					...
					<div class="col-md-4 offset-md-4 px-3">
						<div class="box b-a-0">
							...
							<div class="p-2 text-xs-center text-muted">
								Bạn chưa có tài khoản? <a class="text-black" href="pages-sign-in.html#"><span class="underline">Đăng ký</span></a>
								<a class="text-black" href="pages-sign-in.html#"><span class="underline">Đăng ký</span></a>
							</div>
						</div>
					</div>
				</div>
